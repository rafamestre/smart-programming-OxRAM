#############################################################################################################
#
# 15/04/2016    V3      A.A      Add of a Z case in Arduino mode to allow WL refresh in single Address mode 
#
#############################################################################################################
...
class Arduino:
        ...
        def programAddressing(self, adrsMode, adrsSingle, startAdrs, stopAdrs, stopAll):
                ...
                elif self.adrsMode == 'Z':
                        ser.write(self.adrsSingle + self.startAdrs + self.stopAdrs + self.stopAll)
                else:
