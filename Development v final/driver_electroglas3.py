...
def manual_load():
    ...
    if linecache.getline('Informations.txt', 4)!="":
        print(linecache.getline('Informations.txt', 4))
        mon_fichier_info = open("Informations.txt", "r")
        for line in mon_fichier_info:
            print(line)
            if 'filepath =' in line:
                FILEPATH = line 
        ...
        chdir(FILEPATH)
        print(os.getcwd())
        copyfile(FILENAME,FILEPATH+'\\auxfile.py')
    ...
    dies = open('C:\Users\cc228997\Desktop\FINAL MAD PROGRAMS\Test_Program_Final\DUT.txt', 'r')
    #compter le nombre de lignes
    linecount = len(open('C:\Users\cc228997\Desktop\FINAL MAD PROGRAMS\Test_Program_Final\DUT.txt', 'rU').readlines())
...
##    ################################# Confirmation du positionement ######################
    ...
    barrette=str(linecache.getline('C:\Users\cc228997\Desktop\FINAL MAD PROGRAMS\Test_Program_Final\DUT.txt', 1))
    barrette=barrette[0:5]
    #chaine = "D-A26" Texte a rechercher
    fichier = open('C:\Users\cc228997\Desktop\FINAL MAD PROGRAMS\Test_Program_Final\\barrette.txt','r')
    ...
    for i in range (2,linecount+1) :
        die=linecache.getline('C:\Users\cc228997\Desktop\FINAL MAD PROGRAMS\Test_Program_Final\DUT.txt', i)
        x = str(int(die[0:2]))
        y = str(int(die[3:]))
        ...
        mon_fichier_info = open("C:\Users\cc228997\Desktop\FINAL MAD PROGRAMS\Test_Program_Final\Informations.txt", "r")
        lotname=linecache.getline('C:\Users\cc228997\Desktop\FINAL MAD PROGRAMS\Test_Program_Final\Informations.txt', 2)
        lotname=lotname.replace("lot name=","")
        lotname=lotname.replace("\n","")

        size_of_memory=linecache.getline('C:\Users\cc228997\Desktop\FINAL MAD PROGRAMS\Test_Program_Final\Informations.txt', 1)
        ...
        wafernumber=linecache.getline('C:\Users\cc228997\Desktop\FINAL MAD PROGRAMS\Test_Program_Final\Informations.txt', 3)
...
def load_from_cassette():
    ...
    wafers = open('C:\Users\cc228997\Desktop\FINAL MAD PROGRAMS\Test_Program_Final\wafer.txt', 'r')
    #compter le nombre de lignes
    wafercount = len(open('C:\Users\cc228997\Desktop\FINAL MAD PROGRAMS\Test_Program_Final\wafer.txt', 'rU').readlines())
    wafers.close()
    dies = open('C:\Users\cc228997\Desktop\FINAL MAD PROGRAMS\Test_Program_Final\DUT.txt', 'r')
    #compter le nombre de lignes
    linecount = len(open('C:\Users\cc228997\Desktop\FINAL MAD PROGRAMS\Test_Program_Final\DUT.txt', 'rU').readlines())
    ...
    for w in range (1,wafercount+1) :   
        wafers = open('C:\Users\cc228997\Desktop\FINAL MAD PROGRAMS\Test_Program_Final\wafer.txt', 'r')
        waf=linecache.getline('C:\Users\cc228997\Desktop\FINAL MAD PROGRAMS\Test_Program_Final\wafer.txt', w)
        print (waf)
